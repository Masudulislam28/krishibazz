...
<div class="container bootstrap snippet">
    <div class="row">
  		<div class="col-sm-8"><h1>Nome Cognome</h1></div>
    ...
    <div class="row">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item text-right"><span class="pull-left"><strong>product category</strong></span> {{$product->crop_category}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Product Name</strong></span> {{$product->Crop_Name}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Quantity</strong></span> {{$product->Quantity}}</li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Price </strong></span>{{$product->Price}}</li>
