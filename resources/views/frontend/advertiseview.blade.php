				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="{{asset('uploads/'.$product->image)}}" /></div>
					...
					<div class="details col-md-6">
						...
						<p class="price">price: {{$product->price}} BDT Per Kg<span></span>  </p>
					
						
						<div class="action">
						
							<a  class="btn btn-default" href="{{route('checkout.form',$product->id)}}" type="button">Interested </a>
